...
last_modified_at: 2020-08-14 12:00:00 +0900
categories:
  - IBus
  - text input
---
...
>>> print(ctx.Introspect(dbus_interface='org.freedesktop.DBus.Introspectable'))
```
...
이제 InmputContext 의 Capabilities 를 설정한후 sigal receiver 들을
...
dbus.String(''), dbus.String(''), dbus.String(''), dbus.String(''),
dbus.String(''), dbus.String(''), dbus.String('')), signature=None, variant_level=1)
```